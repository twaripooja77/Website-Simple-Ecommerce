                ...
                <div class="card-body p-md-5">
                  <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                      ...
                      <form class="mx-1 mx-md-4" action="admindashboard.php" method="POST">
...
if(isset($_POST['submit'])){
    $query="SELECT * FROM `tbl_admin` WHERE `admin_username`='$_POST[username]' AND `admin_password`='$_POST[password]'";
    $result=mysqli_query($conn,$query);
    if(mysqli_num_rows($result)==1)
    {
      session_start();
      $_SESSION['myAdmin']=$_POST['admin_username'] ;
