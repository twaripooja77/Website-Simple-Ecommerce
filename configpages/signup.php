...
$select="SELECT * FROM tbl_user WHERE user_email='$email' && user_password='$password'";
...
if(mysqli_num_rows($result) > 0){
  ...
  if($password != $cpassword){
      ...
      $insert="INSERT INTO tbl_user(user_name,user_email, user_password) VALUES('$name','$email','$password')";
