        ...
        <div class="container py-3">
          <div class="row align-items-center">
            ...
            <div class="col-6 text-right">
              <div class="mr-auto">
                <a href="configpages/login.php" class="p-2 pl-0"><span class="icon-user">  LOGIN</span></a>
...
?>
    ...
    <!-- <div class="hero" style="background-ima: url('images/redbox.jpg');"></div>
   -->
...
function createTreeView($category, $sub_category) {
   $html = "";
   if (isset($sub_category['category'][$category])) {
      $html .= "<ol class='tree'&>";
       foreach ($sub_category['category'][$category] as $itemId) {
          if(!isset($sub_category['category'][$itemId])) {
             $html .= "<li><label for='subfolder2'> <a href='".$sub_category['items'][$itemId]['link']."'>" .$sub_category['items'][$itemId]['label']." </a> </label></li>";
          }
          if(isset($sub_category['category'][$itemId])) {
             $html .= "<li><label for='subfolder2'> <a href='".$sub_category['items'][$itemId]['link']."'>" .$sub_category['items'][$itemId]['label']." </a> </label>   </li>";
             $html .= createTreeView($itemId, $sub_category);
             $html .= "</li>";
